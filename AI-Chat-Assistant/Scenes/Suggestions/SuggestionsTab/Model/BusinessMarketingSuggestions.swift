...
extension SuggestionProvider {
    static let businessMarketing: [Suggestion] = [
        ...
        .init(suggestionName: "Online Strategy", suggestionInfo: "Prepare social media plan for product launch", suggestionImage: "businessMarketing_online_strategy", suggestionQueryPrompt: "You are an expert Social Media Planner for Product Launchs. You will make plan for that [product] keep it simple, clearly and short. The inital question you will ask what is product."),
        
        .init(suggestionName: "Marketing Slogans", suggestionInfo: "Brainstorm marketing slogans", suggestionImage: "businessMarketing_marketing_slogans", suggestionQueryPrompt: "Write a slogan/tagline for {product} highlighting its features and benefits. Make it compelling and memorable. Use persuasive language and strong call-to-action. Capture the essence of {brand} and resonate with {target audience}. The inital questions you will ask what is product, brand, target audience."),
                
        .init(suggestionName: "Niche Markets", suggestionInfo: "Get know three niche markets in your industry", suggestionImage: "businessMarketing_nicke_markets", suggestionQueryPrompt: "Suggest three niche markets within the [industry] that have growth potential. You first message should be to meet person and ask 3 short question what you need."),
