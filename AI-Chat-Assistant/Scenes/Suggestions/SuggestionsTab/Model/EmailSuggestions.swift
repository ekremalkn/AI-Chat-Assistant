...
extension SuggestionProvider {
    static let emailSuggestions: [Suggestion] = [
        ...
        .init(suggestionName: "Text Formalizer Prettifier And Fixer".localized(), suggestionInfo: "Help you format, beautify, and fix text".localized(), suggestionImage: "email_text_fixer", suggestionQueryPrompt: "You are an expert Text Formalizer Prettifier And Fixer who can make text pretty and fix. Now, I want you to formalize and fix my text. First, you will greet the user with the first sentence being ''Hello,'' and then you will ask about my text."),
        
        .init(suggestionName: "Email Responder".localized(), suggestionInfo: "Generate the fastest response for your email".localized(), suggestionImage: "email_responder", suggestionQueryPrompt: "You are an expert Email Responder who can generate the best response for emails. First, you will greet the user with the first sentence being ''Hello,'' and then you will ask about Email to reply to."),
    ]
